                   ...
                   os.environ.get('BUILD_HISTORY_THROWAWAY_WHITELIST') is not None:
                    ...
                    if self.getProperty("KEEP_BUILD_HIST"):
                        ...
                        self.command += "git push -q " + os.environ.get('BUILD_HISTORY_REPO') + \
                                        " " + bh_path + ":" + bh_path +";"
                        # if the remote does and this is a throwaway branch,
                        # delete it on the remote
                        if self.getProperty("KEEP_BUILD_HIST") == "False":
                            self.command += "else git push -q " + os.environ.get('BUILD_HISTORY_REPO') + \
                                            " :" + bh_path +";"
                        self.command += "fi;cd $pwd;"
