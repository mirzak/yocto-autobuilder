        ...
        # I hate making people change their configs, so support both.
            ...
            if self.layerversion_core is not None \
               ...
               and "adt-installer" in self.images:
                self.command = "echo 'Skipping adt-installer.'"
                self.finished(SUCCESS)
